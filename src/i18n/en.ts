export const en = {
  ...
  software: {
    ...
    outcomes: {
      ...
      items: [
        "A working application deployed in your environment or hosted for you",
        "Data model and permission structure documented for handover",
        "User training and a written operating guide",
        "An enhancement path — the system is expected to change as your process does",
      ],
    },
    proof: {
  ...
  certitrack: {
      ...
      items: [
        {
          ...
          body:
            "Every certified asset with its certificate, issuing body, scope, validity dates and supporting document held together.",
        },
        {
          title: "Expiry alerts",
          body:
            "Configurable warnings ahead of expiry, so renewals are planned against operations rather than discovered during them.",
        },
        {
    ...
    outcome: {
      title: "The outcome",
      body:
        "Clear visibility over certified assets, and a materially lower risk of expired, missing or uncontrolled records affecting operations.",
    },
  },
  ...
  auditing: {
    ...
    services: {
      ...
      items: [
        {
          title: "API Q1 readiness and gap assessment",
          body:
            "A clause-by-clause assessment of your manufacturing quality management system against API Spec Q1, with prioritised gaps and a realistic closure plan.",
        },
        {
          title: "API Q2 readiness and gap assessment",
          body:
        ...
        {
          title: "Supplier and vendor assessment",
          body:
            "On-site or documented assessment of suppliers against your approval criteria, with a clear recommendation.",
        },
        {
        ...
        },
        {
          ...
          body:
            "Root cause challenge, action verification and effectiveness review, so the same nonconformity does not return next cycle.",
        },
      ],
    },
    deliverables: {
      title: "What you receive",
      items: [
        "An audit report with findings classified and tied to clause and objective evidence",
        "A prioritised gap register with recommended actions and realistic timelines",
        "A closure and verification record for each action",
        "A management debrief covering systemic issues, not only individual findings",
      ],
    },
  },
      ...
      items: [
        {
          ...
          body:
            "Visual and documented inspection of oilfield and industrial equipment against specification, standard and operating condition.",
        },
        {
          title: "Rig and workover unit inspection",
          body:
            "Inspection of critical rig and workover equipment, review of inspection records, verification of certification status and assessment of maintenance documentation.",
        },
        {
          title: "Certification verification",
          body:
            "Confirming that certificates are valid, in scope, traceable to the asset, and issued by an acceptable body.",
        },
        {
          title: "Pre-mobilisation and acceptance",
          body:
            "Verification that equipment is fit for purpose and properly documented before it is accepted or mobilised.",
        },
        {
        ...
        },
        {
          ...
          body:
            "Condition and documentation assessment of third-party equipment before it enters your operation.",
        },
      ],
    },
    deliverables: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          body: "A structured report with findings, supporting evidence, assessed cause and recommendations.",
        },
      ],
    },
    uses: {
  ...
  contact: {
    ...
    form: {
      ...
      interestOptions: [
        ...
        "CertiTrack Plus",
        "API Q1 / Q2 audit support",
        "Equipment inspection",
        "Rig or workover unit inspection",
        "Damage beyond repair investigation",
        "Something else",
      ],
      message: "Tell us about the requirement",
      messagePlaceholder:
        "Equipment, standard, location, timeline — whatever helps us give you a useful first answer.",
      consent:
        "I agree that Reispeq Technologies LLC may use these details to respond to my enquiry.",
      submit: "Send enquiry",
      submitting: "Sending…",
      successTitle: "Thank you — your enquiry has been received.",
      successBody: "A member of our team will respond within one working day.",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Yes. Correspondence, meetings and deliverables can be provided in Arabic or English, or bilingually where a document needs to serve both audiences.",
        },
        {
          q: "Are you a certification body?",
          a: "No. We provide audit support, preparation, internal audit and independent assessment. Certification is issued by accredited certification bodies, and we help you be ready for them.",
        },
        {
          q: "How quickly can you mobilise for an inspection?",
          a: "It depends on location and scope. Tell us the site and the equipment and we will give you a realistic date rather than an optimistic one.",
        },
      ],
    },
  },
  ...
  footer: {
    ...
    productCol: "Product",
    contactCol: "Contact",
    regionsTitle: "Regions served",
    rights: "All rights reserved.",
    legalNote:
      "Reispeq Technologies LLC provides audit support and independent assessment services. It is not an accredited certification body.",
  ...
  seo: {
    ...
    inspection: {
      ...
      description:
        "Independent equipment inspection, rig and workover unit inspection, certification verification and post-repair verification for oilfield and industrial operations.",
    },
    investigations: {
      title: "Damage Beyond Repair (DBR) Investigations & Technical Reporting",
      description:
        "Structured investigation of failed or damaged equipment: evidence collection, documentation review, cause assessment and technical reporting for claims and corrective action.",
    },
    contact: {
